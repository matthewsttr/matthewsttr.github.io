...
Where $C_1$ is a free parameter. (P.S. check that this solution works by hand).

Now suppose we want to find a particular solution by introducing an initial condition:
